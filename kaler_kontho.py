...
def search_kalerkantho(query, api_key, cx, max_results=100):
...
def main():
    ...
    cx = os.getenv('KALER_KONTHO_CX')

    if not api_key or not cx:
        print("Please set the GOOGLE_API_KEY and KALER_KONTHO_CX environment variables.")
        return
    ...
    results = search_kalerkantho(keyword, api_key, cx, max_results)
    ...
    filename = f"kalerkantho_search_{keyword}_{timestamp}.xlsx"
